...
class TestValidation(unittest.TestCase):
	...
	def test_simple(self):
		...
		self.assertEqual(validate(url, INPUT_SECRET, OUTPUT_SECRET), excpected_result)
	...
	def test_invalid_url(self):
		...
		self.assertEqual(validate(fakeurl, INPUT_SECRET, OUTPUT_SECRET), excpected_result)
